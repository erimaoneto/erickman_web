...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $settings = [
            ...
            ['key' => 'show_about_secondary_image', 'value' => '1', 'group' => 'toggles', 'type' => 'boolean', 'label' => 'Tampilkan Foto Mengambang Sekunder'],
        ];
        ...
        // About Pillars (Cleared & Deprecated)
        ...
        if (Fleet::count() === 0) {
            ...
            $fleet2 = Fleet::create([
                ...
                'kir_expiry' => Carbon::now()->addDays(25),
            ...
            $fleet4 = Fleet::create([
                ...
                'kir_expiry' => Carbon::now()->subDays(5),
